    ...
    <div class="row">
        ...
        <div class="col-md-3 ftco-animate">
            <div class="product text-center">
                <a href="/article_by_reference/{{ $product->id }}" class="img-prod"><img class="img-fluid img-thumbnail square-image" src="/storage/{{$product->product_image}}" alt="{{$product->product_name}}">
  ...
  <div class="container">
      <div class="row">
          @foreach ($randomProducts as $randomproduct)     
           <div class="col-md-3 ftco-animate">
              <div class="product">
                <a href="/article_by_reference/{{ $randomproduct->id }}" class="img-prod"><img class="img-fluid img-thumbnail square-image" src="/storage/{{$randomproduct->product_image}}" alt="{{$randomproduct->product_name}}"></a>
              </div>
            </div>
          @endforeach
      </div>
